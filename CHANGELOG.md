...
8.1.31
--------------------------------------------------------------------------------
_Release Date: 2022-07-14_

- Fix importer widget when the legacy api fails to return data.
...
- D8CORE-5684: adding additional visual cues (#116)

8.x-1.29
--------------------------------------------------------------------------------
_Release Date: 2022-05-09_

- Fixed filter parameter in json api url

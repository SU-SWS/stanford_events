...
namespace Drupal\Tests\stanford_localist_importer\Kernel\Plugin\Field\FieldWidget;
 ...
 *
 * @group stanford_localist_importer
 * @coversDefaultClass \Drupal\stanford_localist_importer\Plugin\Field\FieldWidget\StanfordEventsImporterAPIURLFieldWidget
 */
class StanfordEventsImporterAPIURLFieldWidgetTest extends KernelTestBase {
  ...
  public function testWidgetForm() {
    ...
    $entity_form_display->setComponent('su_event_xml_url', ['type' => 'stanford_localist_importer_apiurl_field_widget'])

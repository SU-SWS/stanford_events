...
namespace Drupal\Tests\stanford_localist_importer\Unit;
 ...
 * @coversDefaultClass \Drupal\stanford_localist_importer\StanfordEventsImporter
 */
class StanfordEventsImporterTest extends UnitTestCase {

  /**
   * @var \Drupal\stanford_localist_importer\StanfordEventsImporter
   */
  public $plugin;
